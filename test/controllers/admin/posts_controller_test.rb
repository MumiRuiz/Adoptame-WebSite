...
class Admin::PostsControllerTest < ActionController::TestCase
  ...
  test "should create admin_post" do
    assert_difference('Admin::Post.count') do
      post :create, admin_post: { content: @admin_post.content, day: @admin_post.day, month: @admin_post.month, nombre: @admin_post.nombre }
    end
  ...
  test "should update admin_post" do
    patch :update, id: @admin_post, admin_post: { content: @admin_post.content, day: @admin_post.day, month: @admin_post.month, nombre: @admin_post.nombre }
    assert_redirected_to admin_post_path(assigns(:admin_post))
  end
